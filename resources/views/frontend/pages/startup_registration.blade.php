   ...
   <section id="services" class="bg-silver-light fromstrat">
      <div class="container">
         ...
         <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 whitebg mt-30">
            ...
            {{ Form::open(array('method'=>'post','id'=> 'startup_step2','class'=>'startupform','url' => 'saveCompanyInfo','files' => true,'class'=>'reservation-form')) }}
                  ...
                  <div class="devidedrow" id="startup_name">
                     ...
                     <div class="col-lg-9 col-md-9 col-sm-7 col-xs-12">
                        <div class="form-group mb-10">
                           ...
                           <input placeholder="Startup Name" value="{{$company_name}}"  type="text" id="tags" name="company_name"  class="form-control">
                  ...
                  <div class="devidedrow" id="address">
                     ...
                     <div class="col-lg-9 col-md-9 col-sm-7 col-xs-12">
                        <div class="form-group mb-10">
                           ...
                           <input placeholder="Add Location" type="text" value="{{$location}}"  id="location" name="location"  class="form-control">
                        </div>
                     </div>
                  </div>
                           ...
                           <div class="styled-select">
                              <select name="country" class="form-control" >
                                 ...
                                 foreach($countries_list as $country_list){
                                  ?>
                                 <option <?php echo old('country') == $country_list->id ? "selected":""; ?> value="{{$country_list->id}}">
                                    {{$country_list->name}}
                                 </option>
                                 <?php }
                                    }
                  ...
                  <div class="devidedrow" id="mobile">
                     ...
                     <div class="col-lg-9 col-md-9 col-sm-7 col-xs-12">
                        <div class="form-group mb-10">
                           ...
                           <input placeholder="Telephone" type="text" value="{{$mobile}}" id="mobile" name="mobile"  class="form-control">
                        </div>
                     </div>
                  </div>
                  <div class="devidedrow" id="website">
                     ...
                     <div class="col-lg-9 col-md-9 col-sm-7 col-xs-12">
                        <div class="form-group mb-10">
                           ...
                           <input placeholder="Add Company Website" value="{{$company_website}}"  type="text" id="company_website" name="company_website"  class="form-control">
                        </div>
                     </div>
                  </div>
                           ...
                           <div class="styled-select">
                              <select name="markets[]" class="form-control js-example-basic-multiple" multiple="multiple">
                                 ...
                                 foreach($sector as $sec){ ?>
                                    <option  value="{{$sec->id}}" <?php echo $sec->id==$markets ? 'selected' :""; ?> >{{$sec->name}}</option>         
                                <?php } }?> 
                              ...
                              <select name="technology[]" class="form-control js-example-basic-multiple" multiple="multiple">
                                 ...
                                 <?php
                                  ...
                                  foreach($technologies as $tech){ ?>
                                    <option value="{{$tech->id}}" <?php echo $tech->id==$technology ? 'selected' :""; ?> >{{$tech->name}}</option>         
                                <?php 
                                 }
                             }?> 
                                 ...
                                 <option value="">- Please Select  -</option>
                                  <?php
                                   ...
                                   foreach($businessGoal as $goal){ ?>
                                    <option value="{{$goal->id}}" <?php echo $goal->id==$business_goal ? 'selected' :""; ?> >
                                       {{$goal->name}}
                                    </option>         
                                    <?php  } } ?>
                              </select>
