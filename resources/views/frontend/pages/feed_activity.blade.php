...
<img src="{{ url('/') }}/images/camera.png" id="upfile1" style="cursor:pointer" />
</div>
<div class="profilepercent">Profile 0%</div>
</div>
<div class="clearfix"></div>
<div class="profilename">{{$f_name." ".$l_name}}</div>
<div class="profiletitle">Title<span><a href="#">Add Now</a></span></div>
<div class="completeprolie"><a href="{{url('/profile_setting')}}">Complete Now</a></div>
</div>
...
<div class="profileimageleft"><img src="{{ url('/') }}/images/map.png"></div> <span class="anme"><a href="#">Investorhain</a></span>
...
<img src="{{ url('/') }}/images/banner_2.jpg" class="img-responsive mb-10">
...
<div class="iamgesection">
<img src="{{ url('/') }}/images/banner.png" class="img-responsive mb-10">
<h5 class="xsMargTop primary"><a href="#">Lorem ipsum dolor sit amet, consectetur adipisi cing elit.</a></h5>
<p class="black">xconomy.com</p>
</div>
