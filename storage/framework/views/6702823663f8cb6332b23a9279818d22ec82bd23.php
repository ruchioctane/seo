<div class="box-body">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12">
            <div class="col-lg-4 col-md-4 col-sm-4">
                <div class="form-group">
                    <?php echo e(Form::label('categories', trans('labels.backend.menus.field.type'), ['class' => 'col-lg-4 col-md-4 col-sm-4 control-label required'])); ?>

                    <div class="col-lg-8 col-md-8 col-sm-8">
                        <?php echo e(Form::select('type', $types, null, ['class' => 'form-control tags box-size', 'required' => 'required'])); ?>
            ...
            <div class="col-lg-8 col-md-8 col-sm-8">
                <div class="form-group">
                    <?php echo e(Form::label('name', trans('labels.backend.menus.field.name'), ['class' => 'col-lg-2 col-md-2 col-sm-2 control-label required'])); ?>

                    <div class="col-lg-10 col-md-10 col-sm-10">
                        <?php echo e(Form::text('name', null, ['class' => 'form-control box-size', 'placeholder' => trans('labels.backend.menus.field.name'), 'required' => 'required'])); ?>
    ...
    <div class="row ">
        <div class="col-lg-12 col-md-12 col-sm-12">
                    ...
                    <div class="col-lg-12">
                        <?php $__currentLoopData = $modules; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $module): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="row modules-list-item">
                                ...
                                <div class="col-lg-2">
                                    <a href="javascript:void(0);"><i class="fa fa-plus add-module-to-menu" data-id="<?php echo e($module->id); ?>" data-name="<?php echo e($module->name); ?>" data-url="<?php echo e($module->url); ?>" data-url_type="route" data-open_in_new_tab="0" data-view_permission_id="<?php echo e($module->view_permission_id); ?>" ></i></a>
                                </div>
                            </div>
            ...
            <div class="col-lg-8 col-md-8 col-sm-8 ">
                 <?php echo e(Form::hidden('items', empty($menu->items) ? '{}' : $menu->items, ['class' => 'menu-items-field'])); ?>
...
<?php $__env->startSection("after-styles"); ?>
     <?php echo Html::style('css/nestable2/jquery.nestable.css'); ?>

<?php $__env->stopSection(); ?>
<?php $__env->startSection("after-scripts"); ?>
    <?php echo e(Html::script('js/nestable2/jquery.nestable.js')); ?>
    ...
    <script type="text/javascript">
        ...
        $("#showMenuModal").on('show.bs.modal', function () {
            $.get("<?php echo e(route('admin.menus.getform')); ?>/" + formName, function(data, status){
                if(status == "success") {
