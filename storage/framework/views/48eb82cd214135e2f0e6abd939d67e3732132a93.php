...
<?php $__env->startSection('page-header'); ?>
    <h1>
        ...
        <small><?php echo e(trans('labels.backend.access.roles.create')); ?></small>
    </h1>
<?php $__env->stopSection(); ?>

<?php $__env->startSection('content'); ?>
    <?php echo e(Form::open(['route' => 'admin.access.role.store', 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'post', 'id' => 'create-role'])); ?>


        <div class="box box-info">
            <div class="box-header with-border">
                <h3 class="box-title"><?php echo e(trans('labels.backend.access.roles.create')); ?></h3>
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-10">
                        <?php echo e(Form::select('associated_permissions', array('all' => trans('labels.general.all'), 'custom' => trans('labels.general.custom')), 'all', ['class' => 'form-control select2 box-size'])); ?>
                                ...
                                <div class="col-xs-12">
                                    <?php if($permissions->count()): ?>
                                        <?php $__currentLoopData = $permissions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $perm): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <input type="checkbox" name="permissions[<?php echo e($perm->id); ?>]" value="<?php echo e($perm->id); ?>" id="perm_<?php echo e($perm->id); ?>" <?php echo e(is_array(old('permissions')) && in_array($perm->id, old('permissions')) ? 'checked' : ''); ?> /> <label for="perm_<?php echo e($perm->id); ?>"><?php echo e($perm->display_name); ?></label>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-10">
                        <?php echo e(Form::text('sort', ($roleCount+1), ['class' => 'form-control box-size', 'placeholder' => trans('validation.attributes.backend.access.roles.sort')])); ?>

                    </div><!--col-lg-10-->
                </div><!--form control-->

                <div class="form-group">
                    <?php echo e(Form::label('status', trans('validation.attributes.backend.access.roles.active'), ['class' => 'col-lg-2 control-label'])); ?>
