                                ...
                                <tr>
                                    <td style="<?php echo e($fontFamily); ?> <?php echo e($style['email-body_cell']); ?>">
                                        ...
                                        <h1 style="<?php echo e($style['header-1']); ?>">
                                            ...
                                            <?php else: ?>
                                                <?php if($level == 'error'): ?>
                                                <?php echo e(trans('strings.emails.auth.error')); ?>

                                                <?php else: ?>
                                                    <?php echo e(trans('strings.emails.auth.greeting')); ?>
                                        ...
                                        <!-- Salutation -->
                                        <p style="<?php echo e($style['paragraph']); ?>">
                                            <?php echo e(trans('strings.emails.auth.regards')); ?><br><?php echo e(app_name()); ?>
                                                ...
                                                <tr>
                                                    <td style="<?php echo e($fontFamily); ?>">
                                                        <p style="<?php echo e($style['paragraph-sub']); ?>">
                                                            <?php echo e(trans('strings.emails.auth.trouble_clicking_button', ['action_text' => $actionText])); ?>
                                ...
                                <tr>
                                    <td style="<?php echo e($fontFamily); ?> <?php echo e($style['email-footer_cell']); ?>">
                                        <p style="<?php echo e($style['paragraph-sub']); ?>">
                                            ...
                                            <a style="<?php echo e($style['anchor']); ?>" href="<?php echo e(url('/')); ?>" target="_blank"><?php echo e(app_name()); ?></a>.
                                            <?php echo e(trans('strings.backend.general.all_rights_reserved')); ?>
