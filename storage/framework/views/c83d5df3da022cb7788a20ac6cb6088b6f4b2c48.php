                ...
                <div class="col-md-8 col-md-push-2">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 col-sm-12">
                            ...
                            <?php echo e(Form::open(array('method'=>'post','id'=> 'header_info','url' => 'saveUser','files' => true,'class'=>'reservation-form'))); ?>
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        ...
                                        <div class="form-group mb-15">
                                            ...
                                            <input placeholder="First Name" value="<?php echo e(old('first_name')); ?>" type="text" id="reservation_name" name="first_name" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        ...
                                        <div class="form-group mb-15">
                                            <i class="fa fa-user"></i>
                                            <input placeholder="Last Name" value="<?php echo e(old('last_name')); ?>" type="text" id="reservation_name" name="last_name" class="form-control">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-sm-6">
                                        ...
                                        <div class="form-group mb-15">
                                            ...
                                            <input placeholder="Email" value="<?php echo e(old('email')); ?>" type="text" id="reservation_email" name="email" class="form-control" >
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <label>* Country </label>
                                                ...
                                                <div class="styled-select">
                                                    <select name="country" class="form-control" >
                                                        ...
                                                        foreach($countries_list as $country){
                                                         ?>
                                                            <option <?php echo  old("country")==$country->id ? "selected":""; ?> value="<?php echo e($country->id); ?>"><?php echo e($country->name); ?></option>
                                                        <?php } ?>
                                                    </select>
                                                </div>
                                            </div>
