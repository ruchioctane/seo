      ...
      <div class="container">
         <div class="row">
            ...
            <div class="col-lg-7 col-md-7 col-sm-7 col-xs-12 save_options">
               ...
               <?php echo e(Form::open(array('url' => '/saveMyInterestOptions','id'=>'form','class'=>'','files' => true))); ?>
                     ...
                     <ul>
                        ...
                        <li class=" <?php echo in_array($sec->id,$selected_sector) ? "sanpandon" :""; ?>">  
                           <div class="inputs">
                              <div class="area">
                                 <span class="input">
                                 <label for="checkbox-4"><?php echo e($sec->name); ?></label>
                                 <input class="sector_checkbox" type="checkbox"  <?php echo in_array($sec->id,$selected_sector) ? "checked" :""; ?> name="markets[]" value="<?php echo e($sec->id); ?>" id="checkbox-4">
                                 </span>
                              </div>
                           </div>
                        </li>
                       ...
                       <?php foreach($technology as $tech){ ?>
                        <li class='<?php echo in_array($tech->id,$selected_technology) ? "sanpandon" :""; ?>'>
                           <div class="inputs">
                              <div class="area">
                                 <span class="input">
                                 <label for="checkbox-4"><?php echo e($tech->name); ?></label>
                                 <input class="technology_checkbox" type="checkbox" name="technology[]" <?php echo in_array($tech->id,$selected_technology) ? "checked" :""; ?> value="<?php echo e($tech->id); ?>" id="checkbox-4">
                                 </span>
                              </div>
                           </div>
                        </li>
                     ...
                     <ul>
                        ...
                        <li class="<?php echo in_array($goal->id,$selected_goal) ? "sanpandon" :""; ?>">
                           <div class="inputs">
                              <div class="area">
                                 <span class="input">
                                 <label for="checkbox-4"><?php echo e($goal->name); ?></label>
                                 <input class="goal_checkbox" type="checkbox" <?php echo in_array($goal->id,$selected_goal) ? "checked" :""; ?> name="business_goal[]" value="<?php echo e($goal->id); ?>" id="checkbox-4">
                                 </span>
                              </div>
                           </div>
                        </li>
