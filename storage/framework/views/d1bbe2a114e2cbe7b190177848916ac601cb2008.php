<?php $__env->startSection('content'); ?>
 ...
 <div class="main-content">
    ...
    <section>
      <div class="container">
        <div class="row">
        <h3 class="text-center font-weight-400"><?php echo e(trans('labels.frontend.auth.login_box_title')); ?></h3>
  ...
  <div class="formdata">
            <?php echo e(Form::open(['route' => 'frontend.auth.login', 'class' => 'clearfix' ,'id'=>'loginform'])); ?>
            ...
            <button type="submit" class="btn btn-dark btn-sm">Login</button>
              ...
              <div class="text-center pt-10  col-lg-8 col-md-8 col-sm-8 col-xs-12">
                <a class="text-theme-colored font-weight-400 font-14" href="#"> <?php echo e(link_to_route('frontend.auth.password.reset', trans('labels.frontend.passwords.forgot_password'))); ?></a>
              </div>
