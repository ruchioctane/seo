                                 ...
                                 <div class="col-lg-12">
                                    ...
                                    <div class="row">
                                       <div class="col-lg-4">
                                        ...
                                        <h3>€<?php echo e($raising_amount); ?></h3>
                                       </div>
                                    </div>
                                        <div class="col-lg-4">
                                          <div class="boxammoutndiv">
                                        ...
                                        <h3>€<?php echo e($prev_raised_amount); ?></h3>
                                       </div>
                                     </div>
                                    </div>
                                 <?php } ?>
                                    ...
                                    <div class="save_specify_round">
                                      ...
                                      <?php echo e(Form::open(array('url' => '/saveSpecifyRound','id'=>'form','class'=>'startupform','files' => true))); ?>
                                    ...
                                    <div class="row">
                                       ...
                                       <div class="col-lg-4">
                                             <div class="text">
                                                <div class="name">
                                                <a class="profile-link" data-type="User" data-id="3565344" href="https://angel.co/assbs-dss"><?php echo e($startup_investor->invited_name); ?></a>
                                                </div>
                                             <div class="role_title">$<?php echo e($startup_investor->funding_round); ?></div>
                                    ...
                                    <div id="accordion1" class="panel-group accordion">
                                       <div class="panel">
                                          ...
                                          <div id="accordion11" class="panel-collapse collapse" role="tablist" aria-expanded="false" style="height: 0px;">
                                             ...
                                             <?php echo e(Form::open(array('url' => '/saveRoundInvestor','id'=>'form','class'=>'startupform','files' => true))); ?>
                                    ...
                                    <div class="linedevided"></div>
                                      <?php echo e(Form::open(array('url' => '/saveTransactData','id'=>'form','class'=>'startupform','files' => true))); ?>
