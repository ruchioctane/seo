    ...
    <section class="mainsectionstartup">
      <div class="container">
       ...
       <?php if (isset($data['market_sector']) && !empty($data['market_sector'])){ ?>
        ...
        <li><label class="checkcontainer mb-0" data-market-id=<?php echo e($sec['market_id']); ?>><?php echo e($sec['name']); ?><input type="checkbox" class="ani_market" value="<?php echo e($sec['market_id']); ?>"><span class="checkmark"></span></label><span class="valueshow"><?php echo e($sec['count']); ?></span></li>
        <?php }
        }
        ?> 
        ...
        <li><label class="checkcontainer mb-0" data-technology-id=<?php echo e($sec['technology_id']); ?>><?php echo e($sec['name']); ?><input type="checkbox" class="ani_technology" value="<?php echo e($sec['technology_id']); ?>"><span class="checkmark"></span></label><span class="valueshow"><?php echo e($sec['count']); ?></span></li>
        <?php }
        }
        ?>  
        </ul>
        ...
        <li><label class="checkcontainer mb-0" data-technology-id=<?php echo e($sec['business_goal_id']); ?>><?php echo e($sec['name']); ?><input type="checkbox" class="ani_business_goal" value="<?php echo e($sec['business_goal_id']); ?>"><span class="checkmark"></span></label><span class="valueshow"><?php echo e($sec['count']); ?></span></li>
        <?php }
        }
        ?>
        </ul>
        ...
        <div class="filetrportion">
          <div class="row">
            ...
            <div class="col-lg-3"><?php echo e($startups->links()); ?></div>
          </div>
          <div class="row">
              <div class="container">
                  <?php $__currentLoopData = $startups_data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $startup): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                   <?php 
                    // stdClass Object
                    // (
                    //     [id] => 1
                    ...
                    <div class="col-sm-3">
                      <article class="post clearfix bg-white">
                        ...
                        <div class="entry-content">
                          <p><?php echo e($startup->id); ?>#<?php echo e($startup->company_name); ?></p>
                          ...
                          <li>Investment Target<span><?php echo e($startup->amount); ?></span></li>
                          <li>Funding Round<span><?php echo e($startup->round_type_text); ?></span></li>
                          <li>Close Date<span><?php echo e($startup->closing_date); ?></span></li>
                          </ul>
                          </div>
                        </div>
                      </article>
